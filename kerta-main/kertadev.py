...
▀▀█████▄    ▀▀███▀▀▀     ▀▀███▀▀▀▀▀       ███     ▀███████████ 
  ...
  ▀                        ███    ███                          
    ...
    """.format(Fore.LIGHTGREEN_EX, len(servisler_sms), Style.RESET_ALL, Fore.LIGHTGREEN_EX))
    try:
        menu = (input(Fore.LIGHTGREEN_EX + " 1- SMS (SLOW)\n\n 2- SMS (FAST)\n\n " + Fore.LIGHTGREEN_EX + "TYPE:"))
        if menu == "":
            continue
        menu = int(menu) 
    except ValueError:
        system("cls||clear")
        print(Fore.LIGHTGREEN_EX + "Hatalı giriş yaptın. Tekrar deneyiniz.")
        sleep(3)
        continue
    if menu == 1:
        system("cls||clear")
        print(Fore.LIGHTGREEN_EX + "Telefon numarasını başında '+90' olmadan yazınız (Birden çoksa 'enter' tuşuna basınız): "+ Fore.LIGHTGREEN_EX, end="")
        tel_no = input()
        tel_liste = []
        if tel_no == "":
            system("cls||clear")
            print(Fore.LIGHTGREEN_EX + "Telefon numaralarının kayıtlı olduğu dosyanın dizinini yazınız: "+ Fore.LIGHTGREEN_EX, end="")
            dizin = input()
            try:
                ...
                system("cls||clear")
                print(Fore.LIGHTGREEN_EX + "Hatalı dosya dizini. Tekrar deneyiniz.")
                sleep(3)
                continue
        else:
            try:
                ...
                system("cls||clear")
                print(Fore._EX + "Hatalı telefon numarası. Tekrar deneyiniz.") 
                sleep(3)
                continue
        system("cls||clear")
        try:
            ...
            system("cls||clear")
            print(Fore.LIGHTGREEN_EX + "Hatalı mail adresi. Tekrar deneyiniz.") 
            sleep(3)
            continue
        system("cls||clear")
        try:
        ...
        try:
            ...
            system("cls||clear")
            print(Fore.LIGHTLIGHTGREEN_EX + "Hatalı giriş yaptın. Tekrar deneyiniz.") 
            sleep(3)
            continue
        system("cls||clear")
        if kere is None: 
        ...
        system("cls||clear")
        print(Fore.LIGHTGREEN_EX + "Telefon numarasını başında '+90' olmadan yazınız: "+ Fore.LIGHTGREEN_EX, end="")
        tel_no = input()
        try:
            int(tel_no)
            if len(tel_no) != 10:
            ...
            system("cls||clear")
            print(Fore.LIGHTGREEN_EX + "Hatalı telefon numarası. Tekrar deneyiniz.") 
            sleep(3)
            continue
        system("cls||clear")
        try:
            print(Fore.LIGHTGREEN_EX + "Mail adresi (Bilmiyorsanız 'enter' tuşuna basın): "+ Fore.LIGHTGREEN_EX, end="")
            mail = input()
            if ("@" not in mail or ".com" not in mail) and mail != "":
                raise
        except:
